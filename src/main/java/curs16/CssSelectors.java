...
public class CssSelectors extends BaseTest{
	...
	public void cssSelectorExample() {
		...
		jse.executeScript("arguments[0].setAttribute('style', 'border:10px solid red')", selectedOption);
		...
		for(WebElement element: menuEntries) {
			jse.executeScript("arguments[0].setAttribute('style', 'border:10px solid red')");
		}
	}
	...
	public void cssSelectorExample2() {
		...
		//first-of-type
		WebElement newReleases = driver.findElement(By.cssSelector("div[id*='sc_tabs']>ul[class*='sc_tabs_titles']>li:first-of-type"));
		jse.executeScript("arguments[0].setAttribute('style','background:green', 'border:10px solid red')", newReleases);
		
		//nth-of-type ---2
		WebElement comingSoon = driver.findElement(By.cssSelector("div[id*='sc_tabs']>ul[class*='sc_tabs_titles']>li:nth-of-type(2)"));
		jse.executeScript("arguments[0].setAttribute('style','background:green', 'border:10px solid red')", comingSoon);
		
		//nth-of-type ---3
				WebElement bestSellers = driver.findElement(By.cssSelector("div[id*='sc_tabs']>ul[class*='sc_tabs_titles']>li:nth-of-type(3)"));
				jse.executeScript("arguments[0].setAttribute('style','background:green', 'border:10px solid red')", bestSellers);
				
		//last-of-type
				WebElement awardWinners = driver.findElement(By.cssSelector("div[id*='sc_tabs']>ul[class*='sc_tabs_titles']>li:last-of-type"));
